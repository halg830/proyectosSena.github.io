...
function Fi(e, t) {
  let n = !1;
  Wt <= xr ? Mi(e) || ((e.n |= ot), (n = !Ai(e))) : (n = !e.has(Fe)),
...
function Ve(e, t, n, r, o, i) {
  ...
  if (t === "clear") l = [...s.values()];
    ...
    switch ((n !== void 0 && l.push(s.get(n)), t)) {
      case "add":
        D(e)
          ? zr(n) && l.push(s.get("length"))
          : (l.push(s.get(mt)), Mt(e) && l.push(s.get(Cr)));
        break;
      case "delete":
        D(e) || (l.push(s.get(mt)), Mt(e) && l.push(s.get(Cr)));
        break;
      case "set":
...
const el = Nr("__proto__,__v_isRef,__isVue"),
  $i = new Set(
...
function Wr(e = !1, t = !1) {
  return function (r, o, i) {
    ...
    return (Hr(o) ? $i.has(o) : el(o)) || (e || xe(r, "get", o), t)
      ? l
      : be(l)
      ? s && zr(o)
        ? l
...
function qi(e = !1) {
  return function (n, r, o, i) {
    ...
    if (
      ...
      return (s.value = o), !0;
    const l = D(n) && zr(r) ? Number(r) < n.length : Y(n, r),
...
function cl(e, t) {
  ...
  return (!Hr(t) || !$i.has(t)) && xe(e, "has", t), n;
}
function ul(e) {
...
function mo(e) {
  e = Z(e);
  const t = Z(this);
  return zn(t).has.call(t, e) || (t.add(e), Ve(t, "add", e, e)), this;
}
function vo(e, t) {
  t = Z(t);
  const n = Z(this),
...
function dn(e) {
  return qt(e) ? e : Jr(e, !1, Ri, bl, Ii);
}
function El(e) {
  return Jr(e, !1, dl, _l, Bi);
}
function Di(e) {
  return Jr(e, !0, fl, yl, Ni);
}
...
function ql(e, t, ...n) {
  ...
  let l,
    a = r[(l = sr(t))] || r[(l = sr($t(t)))];
  !a && i && (a = r[(l = sr(Bt(t)))]), a && Le(a, e, 6, o);
  const u = r[l + "Once"];
  if (u) {
...
function ar(e) {
  ...
  try {
    if (n.shapeFlag & 4) {
      const L = o || r;
      (P = He(h.call(L, L, p, i, _, d, x))), (I = a);
    } else {
      const L = t;
      (P = He(
        L.length > 1 ? L(i, { attrs: a, slots: l, emit: u }) : L(i, null)
      )),
        (I = t.props ? a : Bl(a));
    }
  } catch (L) {
    (en.length = 0), Un(L, e, 1), (P = pe(Re));
  }
  let j = P;
  if (I && E !== !1) {
    const L = Object.keys(I),
      { shapeFlag: B } = j;
    L.length && B & 7 && (s && L.some(Dr) && (I = Nl(I, s)), (j = it(j, I)));
  }
  return (
...
function Yi(
  ...
  if (
    (be(e)
      ...
      : D(e)
      ? ((p = !0),
        (h = e.some((L) => Ot(L) || Mn(L))),
        (u = () =>
          e.map((L) => {
            if (be(L)) return L.value;
            if (Ot(L)) return gt(L);
            if (K(L)) return rt(L, a, 2);
          })))
      : K(e)
      ? t
        ? (u = () => rt(e, a, 2))
  ...
  if (ln)
    if (
      ...
      const L = ja();
      x = L.__watcherHandles || (L.__watcherHandles = []);
    } else return qe;
  ...
  const P = () => {
    if (S.active)
      if (t) {
        const L = S.run();
        (r || h || (p ? L.some((B, V) => tn(B, E[V])) : tn(L, E))) &&
          (d && d(),
          Le(t, a, 3, [L, E === bn ? void 0 : p && E[0] === bn ? [] : E, _]),
          (E = L));
      } else S.run();
  };
  P.allowRecurse = !!t;
  ...
  t
    ...
    : S.run();
  const j = () => {
    S.stop(), a && a.scope && jr(a.scope.effects, S);
  };
  return x && x.push(j), j;
}
function Kl(e, t, n) {
  ...
  const {
    ...
    U = {
      ...
      beforeEnter(M) {
        ...
        const N = L[j];
        N && ht(e, N) && N.el._leaveCb && N.el._leaveCb(), B(F, [M]);
      },
      enter(M) {
        let F = a,
          N = u,
          $ = h;
        if (!n.isMounted)
          if (o) (F = P || a), (N = I || u), ($ = S || h);
          else return;
        let T = !1;
        const Q = (M._enterCb = (A) => {
          T ||
            ((T = !0),
            A ? B($, [M]) : B(N, [M]),
      ...
      leave(M, F) {
        ...
        if ((M._enterCb && M._enterCb(!0), n.isUnmounting)) return F();
        B(p, [M]);
        let $ = !1;
        const T = (M._leaveCb = (Q) => {
          $ ||
            (($ = !0),
            F(),
            Q ? B(x, [M]) : B(_, [M]),
...
function cr(e) {
  if (Qn(e)) return (e = it(e)), (e.children = null), e;
}
function xo(e) {
...
function ns(e, t, n = ge) {
  ...
  if ((Jn(t, r, n), n)) {
    let o = n.parent;
    for (; o && o.parent; )
      Qn(o.parent.vnode) && Yl(r, t, n, o), (o = o.parent);
  }
}
function Yl(e, t, n, r) {
  const o = Jn(t, e, r, !0);
...
const Sr = (e) => (e ? (hs(e) ? Zn(e) || e.proxy : Sr(e.parent)) : null),
  ...
  ur = (e, t) => e !== se && !e.__isScriptSetup && Y(e, t),
  ia = {
    get({ _: e }, t) {
      const {
        ctx: n,
...
function sa(e) {
  const t = no(e),
    n = e.proxy,
    r = e.ctx;
  (Lr = !1), t.beforeCreate && Eo(t.beforeCreate, e, "bc");
  const {
    data: o,
    computed: i,
    methods: s,
      ...
      mount(u, h, p) {
        if (!l) {
          ...
          return (
            ...
            (a._container = u),
            (u.__vue_app__ = a),
            Zn(d.component) || d.component.proxy
          );
        }
      },
      unmount() {
...
function pa(e, t, n, r = !1) {
  const o = {},
    i = {};
  An(i, Xn, 1), (e.propsDefaults = Object.create(null)), is(e, t, o, i);
...
function Or(e, t, n, r, o = !1) {
  if (D(e)) {
    e.forEach((d, _) => Or(d, t && (D(t) ? t[_] : t), n, r, o));
    return;
  }
  if (Tn(r) && !o) return;
  const i = r.shapeFlag & 4 ? Zn(r.component) || r.component.proxy : r.el,
    s = o ? null : i,
    { i: l, r: a } = e,
    u = t && t.r,
...
function ya(e, t) {
  ...
  const {
    ...
    E = (
      ...
      const { type: b, ref: q, shapeFlag: O } = f;
      switch (b) {
        case Yn:
          P(c, f, g, v);
          break;
        ...
        default:
          O & 1
            ...
            : O & 6
            ? Q(c, f, g, v, m, w, k, y, C)
            : (O & 64 || O & 128) && b.process(c, f, g, v, m, w, k, y, C, Be);
      }
      q != null && m && Or(q, c && c.ref, w, f || c, !f);
    },
    P = (c, f, g, v) => {
    ...
    B = (c, f, g, v, m, w, k, y, C) => {
      (k = k || f.type === "svg"),
        c == null ? V(f, g, v, m, w, k, y, C) : F(c, f, m, w, k, y, C);
    },
    V = (c, f, g, v, m, w, k, y) => {
      let C, b;
      const { type: q, props: O, shapeFlag: R, transition: z, dirs: W } = c;
      if (
        ((C = c.el = s(c.type, w, O && O.is, O)),
        R & 8
          ? h(C, c.children)
          : R & 16 &&
            M(c.children, C, null, v, m, w && q !== "foreignObject", k, y),
        ...
        for (const ne in O)
          ne !== "value" &&
            !Cn(ne) &&
            i(C, ne, null, O[ne], w, c.children, v, m, oe);
        "value" in O && i(C, "value", null, O.value),
          (b = O.onVnodeBeforeMount) && De(b, v, c);
      }
      W && st(c, null, v, "beforeMount");
      const ie = (!m || (m && !m.pendingBranch)) && z && !z.persisted;
      ie && z.beforeEnter(C),
        r(C, f, g),
        ((b = O && O.onVnodeMounted) || ie || W) &&
          ye(() => {
    ...
    F = (c, f, g, v, m, w, k) => {
      ...
      if (
        ...
        if (C & 16) $(y, f, O, R, g, v, m);
        else if (
          (C & 2 && O.class !== R.class && i(y, "class", null, R.class, m),
          C & 4 && i(y, "style", O.style, R.style, m),
          C & 8)
        ) {
    ...
    T = (c, f, g, v, m, w, k, y, C) => {
      ...
      let { patchFlag: O, dynamicChildren: R, slotScopeIds: z } = f;
      z && (y = y ? y.concat(z) : z),
        c == null
          ? (r(b, g, v), r(q, g, v), M(f.children, g, q, m, w, k, y, C))
          : O > 0 && O & 64 && R && c.dynamicChildren
    ...
    A = (c, f, g, v, m, w, k) => {
      ...
      if ((Qn(c) && (y.ctx.renderer = Be), qa(y), y.asyncDep)) {
    ...
    ee = (c, f, g, v, m, w, k) => {
      const y = () => {
          if (c.isMounted) {
            let { next: q, bu: O, u: R, parent: z, vnode: W } = c,
              ie = q,
              ne;
            lt(c, !1),
            ...
            if (
              ...
              const fe = () => {
                (c.subTree = ar(c)), ir(O, c.subTree, c, m, null);
              };
              ne
                ? f.type.__asyncLoader().then(() => !c.isUnmounted && fe())
                : fe();
            } else {
              const fe = (c.subTree = ar(c));
        ...
        C = (c.effect = new Ur(y, () => Zr(b), c.scope)),
        b = (c.update = () => C.run());
      (b.id = c.uid), lt(c, !0), b();
    },
    re = (c, f, g) => {
    ...
    G = (c, f, g, v, m, w, k, y, C = !1) => {
      ...
      if (R > 0) {
        if (R & 128) {
          Ye(b, O, g, v, m, w, k, y, C);
          return;
        } else if (R & 256) {
          Ie(b, O, g, v, m, w, k, y, C);
          return;
        }
      }
      z & 8
        ? (q & 16 && oe(b, m, w), O !== b && h(g, O))
        : q & 16
        ? z & 16
          ? Ye(b, O, g, v, m, w, k, y, C)
          : oe(b, m, w, !0)
        : (q & 8 && h(g, ""), z & 16 && M(O, g, v, m, w, k, y, C));
    },
    Ie = (c, f, g, v, m, w, k, y, C) => {
      ...
      b > q ? oe(c, m, w, !0, !1, O) : M(f, g, v, m, w, k, y, C, O);
    },
    Ye = (c, f, g, v, m, w, k, y, C) => {
      ...
      } else if (b > R) for (; b <= O; ) Ee(c[b], m, w, !0), b++;
      else {
        const z = b,
          W = b,
          ie = new Map();
    ...
    Ke = (c, f, g, v, m = null) => {
      ...
      if (k === we) {
        r(w, f, g);
        for (let O = 0; O < C.length; O++) Ke(C[O], f, g, v);
        r(c.anchor, f, g);
        return;
      }
      if (k === fr) {
      ...
      if (v !== 2 && b & 1 && y)
        if (v === 0) y.beforeEnter(w), r(w, f, g), ye(() => y.enter(w), m);
          ...
          const { leave: O, delayLeave: R, afterLeave: z } = y,
            W = () => r(w, f, g),
            ie = () => {
              O(w, () => {
                W(), z && z();
    ...
    Ee = (c, f, g, v = !1, m = !1) => {
      ...
      if ((y != null && Or(y, null, g, c, !0), q & 256)) {
        f.ctx.deactivate(c);
        return;
      }
      const z = q & 1 && R,
  ...
  let or, ir;
  return (
    t && ([or, ir] = t(Be)), { render: jt, hydrate: or, createApp: da(jt, or) }
  );
}
  ...
  Ca = {
    ...
    process(e, t, n, r, o, i, s, l, a, u) {
      const {
        ...
        I = Gt(t.props);
      let { shapeFlag: S, children: j, dynamicChildren: L } = t;
      if (e == null) {
        const B = (t.el = E("")),
          V = (t.anchor = E(""));
        _(B, n, r), _(V, n, r);
        const U = (t.target = Fr(t.props, x)),
          M = (t.targetAnchor = E(""));
        U && (_(M, U), (s = s || Mo(U)));
        const F = (N, $) => {
        ...
        if (
          ((s = s || Mo(V)),
          L
            ? (d(e.dynamicChildren, L, F, o, i, s, l), oo(e, t, !0))
            : a || p(e, t, F, N, o, i, s, l, !1),
          I)
        )
          M || yn(t, n, B, u, 1);
        else if ((t.props && t.props.to) !== (e.props && e.props.to)) {
          const $ = (t.target = Fr(t.props, x));
          $ && yn(t, $, null, u, 0);
        } else M && yn(t, V, U, u, 1);
      }
      us(t);
...
function Ma(...e) {
  ...
  for (let n = 0; n < e.length; n++) {
    ...
    for (const o in r)
      ...
      else if (o === "style") t.style = jn([t.style, r.style]);
      else if (Bn(o)) {
        const i = t[o],
          s = r[o];
        s &&
...
function Ra(e, t) {
  const n = e.type;
  (e.accessCache = Object.create(null)), (e.proxy = Kn(new Proxy(e.ctx, ia)));
  const { setup: r } = n;
  if (r) {
...
function Zn(e) {
  if (e.exposed)
    return (
      e.exposeProxy ||
      (e.exposeProxy = new Proxy(Ki(Kn(e.exposed)), {
        get(t, n) {
...
function Wa(e, t, n) {
  const r = e.style,
    o = ue(n);
  if (n && !o) {
    if (t && !ue(t)) for (const i in t) n[i] == null && qr(r, i, "");
...
const ec = Promise.resolve(),
  tc = () => hr || (ec.then(() => (hr = 0)), (hr = Date.now()));
function nc(e, t) {
  const n = (r) => {
  ...
  return he(t, {
    ...
    onLeave(T, Q) {
      ...
      et(T, p),
        ...
        et(T, d),
        Ko(() => {
          T._isLeaving && (ct(T, p), et(T, _), zo(L) || Uo(T, r, P, A));
        }),
        at(L, [T, A]);
    },
    onEnterCancelled(T) {
...
function lc(e) {
  ...
  if (le(e)) return [pr(e.enter), pr(e.leave)];
  {
    const t = pr(e);
    return [t, t];
  }
    ...
    install(e) {
      ...
      wt.value === !0
        ? (e.onSSRHydrated.push(() => {
            Object.assign(t.platform, de), (wt.value = !1), (er = void 0);
          }),
          (t.platform = dn(this)))
        : (t.platform = this);
    },
  };
{
  ...
  Gn(de.has, "webStorage", () => {
    ...
    wt.value === !0 ? Object.assign(Rr, de, er, _c) : Object.assign(Rr, de);
}
const tr = (e, t) => {
    const n = dn(e);
    for (const r in e)
...
const Ct = (e) => Kn(Ql(e)),
  ...
  Br = { xs: 18, sm: 24, md: 32, lg: 38, xl: 46 },
  Cs = { size: String };
function Es(e, t = Br) {
  return H(() =>
    e.size !== void 0
...
function Gc(e) {
  return {
    cSize: H(() => (e.size in Br ? `${Br[e.size]}px` : e.size)),
...
function du({ fallbackTag: e, useDisableForRouterLinkProps: t = !0 } = {}) {
  const n = Je(),
    ...
    x = H(() => {
      ...
      const F = M.findIndex(ci.bind(null, U));
      if (F > -1) return F;
      const N = ai(B[V - 2]);
      return V > 1 && ai(U) === N && M[M.length - 1].path !== N
        ? M.findIndex(ci.bind(null, B[V - 2]))
        : F;
    }),
    E = H(
      () =>
  ...
  function j(
    B,
    { returnRouterError: V, to: U = r.to, replace: M = r.replace } = {}
  ) {
    ...
    B.preventDefault();
    const F = o.$router[M === !0 ? "replace" : "push"](U);
    return V === !0 ? F : F.then(() => {}).catch(() => {});
  }
  function L(B) {
    if (h.value === !0) {
      const V = (U) => j(B, U);
...
const yu = Ct({
    ...
    setup(e, { slots: t, emit: n }) {
      ...
      const I = H(
        ...
        B = H(() => {
          ...
          if (p.value === !0) {
            const A = { onClick: U, onKeydown: M, onMousedown: N };
      ...
      function $(A) {
        if (
          ...
          if (A !== void 0 && A.type === "keyup") {
            if (St === d.value && un(A, [13, 32]) === !0) {
              const te = new MouseEvent("click", A);
              (te.qKeyEvent = !0),
                A.defaultPrevented === !0 && xc(te),
                A.cancelBubble === !0 && vs(te),
      ...
      return (
        ...
        () => {
          ...
          e.icon !== void 0 &&
            ...
            I.value === !0 && A.push(X("span", { class: "block" }, [e.label])),
            (A = Jt(t.default, A)),
            e.iconRight !== void 0 &&
              e.round === !1 &&
              A.push(
  ...
  di = Ct({
    ...
    setup(e, { slots: t }) {
      ...
      return () => X(e.tag, { class: n.value }, nr(t.default));
    },
  }),
...
const Cu = Ct({
  ...
  setup(e, { slots: t }) {
    ...
    return () => X(e.tag, { class: o.value }, nr(t.default));
  },
});
function Eu(e, t, n) {
  let r;
  function o() {
    r !== void 0 && (Ir.remove(r), (r = void 0));
  }
  return (
    xt(() => {
      e.value === !0 && o();
    }),
    {
      removeFromHistory: o,
      addToHistory() {
        (r = { condition: () => n.value === !0, handler: t }), Ir.add(r);
      },
    }
  );
}
...
function bi(e) {
  ...
  de.is.desktop === !0 &&
    ...
    e === "remove" &&
      ...
      (t.style.left = pi),
      (t.style.top = gi),
      window.location.href === mi && window.scrollTo(vr, br),
      (Xt = void 0));
}
function Qu(e) {
  let t = "add";
  ...
  nf = Ct({
    ...
    setup(e, { slots: t, emit: n, attrs: r }) {
      ...
      const d = H(
        ...
        { addToHistory: M, removeFromHistory: F } = Eu(s, U, d),
        N = H(
          () =>
...
const rf = xs({
  ...
  _f = "./assets/ganar-4a9268dd.jpg";
const yf = (e, t) => {
    const n = e.__vccOpts || e;
    for (const [r, o] of t) n[r] = o;
    return n;
  },
  lo = (e) => (Rl("data-v-f8360cf0"), (e = e()), Il(), e),
  ...
  Hf = Object.assign(jf, {
    ...
    setup(e) {
      const t = ce(!0),
        n = Array.from({ length: 26 }, (F, N) => String.fromCharCode(65 + N)),
        r = ce(!0),
        ...
        a = () => {
          console.log(o.value);
          const F = i[o.value.categoria][o.value.dificultad][s()],
            N = Array.from(F);
        ...
        _ = (F) => {
          if ((console.log("principio"), l.value.includes(F.toLowerCase()))) {
            if (
              (console.log(
                u.value.includes(F),
                "data",
              ...
              u.value.includes(F) && o.value.dificultad === "Difícil")
            ) {
        ...
        x = H(
          () => (F) =>
            u.value.find(($) => String($) === String(F.toUpperCase())) ? F : ""
        ),
        E = H(() => {
          let F = !1;
        ...
        U = async (F) => {
          (u.value = [""]),
            ...
            (o.value.dificultad = F),
            a(),
            (t.value = !1),
            (V.value = !0);
        },
        M = (F) => {
          (o.value.categoria = F), (r.value = !1);
        };
      return (F, N) => (
        je(),
        Ue("div", null, [
  ...
  zf = yf(Hf, [["__scopeId", "data-v-f8360cf0"]]),
  $s = hc(zf);
$s.use(Hc, { plugins: {} });
$s.mount("#app");
